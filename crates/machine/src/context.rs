...
///
/// The reactor → policy contract is "errors are data": any failure surfaces
/// through the inbox as a hitch fragment rather than panicking. Stale
/// fragment ids surface here for the same reason.
