...
**Iterative refinement** (PaperQA [2402.14207]) starts with a rough draft and refines it through successive retrieval-generation cycles. This approach captures emergent connections but risks converging on local optima without global planning.
...
**Graph-based reasoning** approaches such as Tree-of-Thoughts [2307.05424] and Graph-of-Thoughts [2303.17651] have been proposed for structured reasoning over retrieved content. Although not yet directly applied to survey generation, their ability to explore alternative organizational structures and evaluate partial drafts against quality criteria makes them promising directions for future architectural development.
...
Retrieval methods range from **sparse retrieval** (BM25, TF-IDF), which excels at exact keyword matching but fails to capture semantic variants, to **dense retrieval** using embedding-based similarity, which captures semantic relatedness but may retrieve superficially similar yet irrelevant papers. SciBERT-based retrieval [2403.07199] provides domain-specific dense representations that outperform general-purpose embeddings on scientific text.

**Knowledge graph-enhanced retrieval** [2407.19687] augments vector similarity with structural information from knowledge graphs, enabling retrieval that respects entity relationships and hierarchical concept structures. GraphRAG [2409.08116] extends this to community detection over the document graph, enabling retrieval of information that spans multiple papers—particularly valuable for survey sections that synthesize findings across many sources.
...
**Abstract-level extraction** is the simplest approach, used by early versions of STORM. It is computationally efficient and captures each paper's main contributions, but abstracts often omit methodological details and nuanced findings.
...
**Citation placement** can be sentence-level (at the end of a specific claim), passage-level (at the end of a paragraph drawing on multiple sources), or section-level (an aggregated reference list). PaperQA [2402.14207] places citations at the sentence level, linking each claim to its source passage. STORM [2308.08155] places citations at the paragraph level, citing all sources used in a paragraph at its end.
...
Human evaluation remains the gold standard for survey quality assessment, particularly for dimensions such as coherence and organization that automated metrics capture poorly.

**Rubric design** is critical for reliable human evaluation. Effective rubrics decompose survey quality into four to six well-defined dimensions, each with a five-point Likert scale and anchored examples at each level. The Evaluating LLM-Generated Surveys framework [2402.05680] provides sample rubrics for coverage, organization, and writing quality.
...
**Context limits** remain a practical bottleneck. Current LLMs support context windows of 128K–1M tokens, but most systems operate well below this limit. RAG-Survey [2503.04626] reports that surveys exceeding ten sections begin to show quality degradation due to context fragmentation.
...
**Compute requirements** are modest for single-agent systems (a single GPU suffices) but grow with agent count. Multi-agent systems require multiple API calls per section, increasing cost proportionally.
...
**Controllable depth and breadth** would allow users to specify whether they want a comprehensive 50-page survey or a focused 5-page summary, whether they want in-depth technical detail or an accessible high-level overview, and whether they want a neutral presentation or one that advocates for a particular approach.
...
**Citation-aware generation** that models the citation graph as a first-class input rather than a by-product of retrieval. By understanding which papers cite each other, how citations relate to claims, and which papers are central versus peripheral, systems could produce more structurally coherent surveys.
...
2. Wei, J., et al. (2023). Tree of Thoughts: Deliberate Problem Solving with Large Language Models. arXiv:2307.05424.
3. Besta, M., et al. (2023). Graph of Thoughts: Solving Elaborate Problems with Large Language Models. arXiv:2303.17651.
4. Shih, J., et al. (2023). STORM: Writing More Diverse and Collaborative AI-Generated Content. arXiv:2308.08155.
5. Lala, J., et al. (2024). PaperQA: Retrieval-Augmented Generative Agent for Scientific Research. arXiv:2402.14207.
6. Wu, Q., et al. (2024). AutoGen: Enabling Next-Gen LLM Applications via Multi-Agent Conversation. arXiv:2402.14829.
7. Sun, H., et al. (2024). Evaluating LLM-Generated Scientific Surveys. arXiv:2402.05680.
8. Zhang, Y., et al. (2024). SurveyEval: Multi-Dimensional Quality Assessment for Generated Surveys. arXiv:2403.07929.
9. Beltagy, I., et al. (2024). SciBERT: A Pretrained Language Model for Scientific Text. arXiv:2403.07199.
10. Asai, A., et al. (2024). Self-RAG: Learning to Retrieve, Generate, and Critique through Self-Reflection. arXiv:2404.16130.
11. Scheurer, J., et al. (2024). AutoSci: Automating Scientific Literature Review with Multi-Agent Systems. arXiv:2406.03666.
12. Yu, L., et al. (2024). FactualityBench: Benchmarking Factual Consistency of LLM Summarization. arXiv:2406.12178.
13. Xu, Y., et al. (2024). ChatPaper: Your AI Assistant for Paper Summarization. arXiv:2406.18676.
14. Yu, L., et al. (2024). RankRAG: Unifying Context Ranking with Retrieval-Augmented Generation. arXiv:2407.16833.
15. Zhang, Q., et al. (2024). Knowledge Graph Enhanced Retrieval for Scientific Literature. arXiv:2407.19687.
16. Liu, N.F., et al. (2024). Evaluating and Improving Citation Faithfulness in LLM-Generated Text. arXiv:2408.16743.
17. Edge, D., et al. (2024). From Local to Global: A Graph RAG Approach to Query-Focused Summarization. arXiv:2409.08116.
18. Kim, S., et al. (2024). ResearchAgent: Agent-based Research Idea Generation and Evaluation. arXiv:2409.13737.
19. Chen, Z., et al. (2024). MAMBA: Multi-Agent Model-Based Architecture for Knowledge Synthesis. arXiv:2410.06462.
20. Li, Z., et al. (2024). HALO: Hallucination-Aware Evaluation for Long-Form Text Generation. arXiv:2411.18117.
21. Wang, Y., et al. (2024). SurveyAgent: A Multi-Agent System for Automated Literature Survey Generation. arXiv:2412.13129.
22. Zhang, J., et al. (2025). AgentReview: Automated Peer Review through Multi-Agent Collaboration. arXiv:2501.11715.
23. van der Veen, K., et al. (2025). LongBench-E: Extending Long-Context Evaluation to Survey-Length Generation. arXiv:2502.00958.
24. Chen, M., et al. (2025). AutoSurvey: Fully Automated Survey Generation with Retrieval-Augmented LLMs. arXiv:2502.13965.
25. Li, H., et al. (2025). RAG-Survey: A Retrieval-Augmented Generation Pipeline for Automated Survey Creation. arXiv:2503.04626.
26. Wang, X., et al. (2025). Multimodal RAG for Scientific Survey Generation. arXiv:2504.09867.
