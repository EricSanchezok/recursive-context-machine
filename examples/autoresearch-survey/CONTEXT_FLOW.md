...
| `survey_writer` | image handoff only | `00`, `05`, `06` artifacts + `08_global_picture.png` if present | `08_survey.md`, `index.md` | `run_dir`, survey path, status, plus the full survey for the user |
| `survey_writer_zh` | survey writer handoff only | `08_survey.md` | `08_survey.zh.md` | `run_dir`, zh survey path, status |
