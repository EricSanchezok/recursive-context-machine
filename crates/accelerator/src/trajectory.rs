...
use machine::obs::Obs;
use machine::{LedgerTransition, MachineState, Overlay, StoredEvent};
...
impl TrajectoryRecorder {
    ...
    /// warn and keep running rather than kill the run.
    pub fn record_step(
        &mut self,
        step: u64,
        obs: &Obs,
        overlay_declared: &Overlay,
        ...
        let trajectory = TrajectoryEvent {
            step,
            obs: obs.clone(),
            overlay_declared: overlay_declared.clone(),
