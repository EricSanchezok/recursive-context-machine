...
try {
    ...
    $phase0Files = @(
        ...
        "01b_query_plan_extended.md",
        "01b_query_plan_extended_analysis.md",
        ...
        "paper_taxonomy.md", "evolution_narrative.md"
    )
